This Model is trained on the Lobachevsky University Electrocardiography Database, with ECG signals sampled to roughly 250 Hz. Citations for used data are placed below:
